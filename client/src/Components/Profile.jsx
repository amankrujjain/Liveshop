                                            ...
                                            <table className='table'>
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        {item.paymentstatus==="Pending"?<Link to={`/payment/${item._id}`} className='text-decoration-none p-1 text-center rounded background text-light mybtn btn-sm'>Pay Now</Link>:""}
                                                        </td>
                                                    </tr>
                                                    {
                                                        item.rppid?<tr>
